        ...
        <div className={styles.serachWithFlight}>
            ...
            <div className={styles.serachWithFlight__listFilter}>
                ...
                <DropFilter
                    ...
                    idTitle={"dateFlight"}
                    idValue={"dateFlight"}
                    value={`${filters.startDateFlightDisplay} - ${filters.endDateFlightDisplay}`}
                    title={"ДАТА ВЫЛЕТА"}
                    icon={"📅"}
                    isActive={isActive(3)}
                    style={{
                ...
                >
                    <DateFlightMenu
                        today={today}
                        onChangeStartDateDisplay={val => handleFilterChange('startDateFlightDisplay', val)}
                        onChangeEndDateDisplay={val => handleFilterChange("endDateFlightDisplay", val)}
